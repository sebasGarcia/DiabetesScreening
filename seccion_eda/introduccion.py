...
st.markdown("""
# Modelado de diagnóstico clínico de diabetes
...
**Navegación** En el menú de la izquierda tienes todo lo necesario para empezar a modelar el diagnóstico clínico
"""
    )
